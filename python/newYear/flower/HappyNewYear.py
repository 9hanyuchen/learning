...
def write():
	...
	coordinates = [(250, -150)] #两端文字的间距
    # coordinates = [(300, -150), (200, -150), (100, -150)]
	for i, p in enumerate(words):
		t.write(p, align="center", font=("STXingkai", 50, "bold"))
		if (i + 1) != len(words):
			time.sleep(1)
...
time.sleep(0.5)
t.setup(1000, 700)
t.bgpic(r'picture/1579425235538.gif')
t.screensize(1200, 1000, "wheat")
t.pensize(5)
t.pencolor("#ff0000")
# t.speed(10)
t.hideturtle()
